    ...
    <section class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <c:forEach var="p" items="${listProduct}">
                <a href="ProductDetails?id=${p.getProduct_id()}">
                    
                    <div class="bg-white shadow-lg rounded-xl p-4 hover:shadow-2xl transition h-full flex flex-col">
                        <img src="Assets/images/${p.image}" alt="${p.product_name}" 
                             class="mx-auto mb-3 h-32 object-contain"/>
                        <p class="font-semibold text-lg mb-1">${p.product_name}</p>
